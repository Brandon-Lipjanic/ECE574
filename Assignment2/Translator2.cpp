	...
	for (i = 0; i < inVec.size(); i++) {
		...
		if (tempStr.find('=') != string::npos) {
			...
			if (tempStr.find('+') != string::npos && tempStr.find("+ 1") == string::npos) {
				...
				//Subtract
				//Start of Module
				newStr = string("SUB") + string("#(") + string(to_string(bitWidth.at(i))) + string(")") + string(" subtractor") + string(to_string(i)) + string("( .a(");
				//Find first variable name
				found = tempStr.find_first_of('=');
				for (j = found + 2; j < tempStr.size(); j++) {
					if (tempStr.at(j) == ' ') {
				...
				//Mul
				//Start of Module
				newStr = string("MUL") + string("#(") + string(to_string(bitWidth.at(i))) + string(")") + string(" multiplier") + string(to_string(i)) + string("( .a(");
				//Find first variable name
				found = tempStr.find_first_of('=');
				for (j = found + 2; j < tempStr.size(); j++) {
					if (tempStr.at(j) == ' ') {
				...
				//Mux
				//Start of Module
				newStr = string("MUX2x1") + string("#(") + string(to_string(bitWidth.at(i))) + string(")") + string(" multiplexer") + string(to_string(i)) + string("( .a(");
				//Find first variable name
				found = tempStr.find_first_of('?');
				for (j = found + 2; j < tempStr.size(); j++) {
					if (tempStr.at(j) == ' ') {
				...
				//Shift Left 
				//Start of Module
				newStr = string("SHL") + string("#(") + string(to_string(bitWidth.at(i))) + string(")") + string(" shiftLeft") + string(to_string(i)) + string("( .a(");
				//Find first variable name
				found = tempStr.find_first_of('=');
				for (j = found + 2; j < tempStr.size(); j++) {
					if (tempStr.at(j) == ' ') {
				...
				//Incrementer
				//Start of Module
				newStr = string("INC") + string("#(") + string(to_string(bitWidth.at(i))) + string(")") + string(" incrementer") + string(to_string(i)) + string("( .a(");
				//Find first variable name
				found = tempStr.find_first_of('=');
				for (j = found + 2; j < tempStr.size(); j++) {
					if (tempStr.at(j) == ' ') {
				...
				//Decrementer
				//Start of Module
				newStr = string("DEC") + string("#(") + string(to_string(bitWidth.at(i))) + string(")") + string(" decrementer") + string(to_string(i)) + string("( .a(");
				//Find first variable name
				found = tempStr.find_first_of('=');
				for (j = found + 2; j < tempStr.size(); j++) {
					if (tempStr.at(j) == ' ') {
